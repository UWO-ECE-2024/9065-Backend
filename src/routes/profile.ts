...
// Get user profile
profileRoutes.get("/", authMiddleware, async (req: AuthRequest, res) => {
    try {
        const user = await db
            .select({
                userId: users.userId,
...
// Update user profile
profileRoutes.put("/", authMiddleware, async (req: AuthRequest, res) => {
    try {
...
// Get all addresses
profileRoutes.get("/addresses", authMiddleware, async (req: AuthRequest, res) => {
    try {
...
// Get default address
profileRoutes.get("/addresses/default", authMiddleware, async (req: AuthRequest, res) => {
    try {
...
// Add new address
profileRoutes.post("/addresses", authMiddleware, async (req: AuthRequest, res) => {
    try {
        // Check address limit
        ...
        const { streetAddress, city, state, postalCode, country, isDefault } = validation.data;
...
// Update address
profileRoutes.put("/addresses/:addressId", authMiddleware, async (req: AuthRequest, res) => {
    try {
...
// Delete address
profileRoutes.delete("/addresses/:addressId", authMiddleware, async (req: AuthRequest, res) => {
    try {
        const addressId = Number(req.params.addressId);
